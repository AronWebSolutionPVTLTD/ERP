                ...
                <div className="w-full max-w-3xl p-5 md:p-8 shadow-ctm_shadow rounded-20px bg-white">
                    <form>
                        ...
                        <div>
                            ...
                            <p className="text-xs font-medium sm:font-normal sm:text-base text-center mt-2">Don't have Account? <span className="cursor-pointer text-primary">Register Now</span></p>
